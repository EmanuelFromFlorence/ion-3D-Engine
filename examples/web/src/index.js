...
window.addEventListener('load', () => {
  ...
  // console.log('sliderGuiEntity.name::: ', sliderGuiEntity.name);
    ...
    // setInterval(() => {
    //   // ss += 10;
    //   rootElement.scrollTop = rootElement.scrollTop + 10;
    // }, 100);
    ...
    //   // rootElement.scrollTop = rootElement.scrollTop + event.deltaY;
    //   // rootElement.scrollTop = 

    //   rootElement.scrollTo(0, event.deltaY);
    //   // rootElement.scrollHeight = event.deltaY;


    //   // rootElement.scroll(0, event.deltaY)
